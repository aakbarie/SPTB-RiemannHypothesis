...
\]
Thus $c_{\mathrm{der}}=4\pi^2$ in the normalization of Part~2
...
$\omega_m\Delta\in[0.1,10]$.  The empirical minimum equals the sharp
constant $4\pi^2/\Delta^2\approx 39.5/\Delta^2$ (empirically $39.483$ versus
$4\pi^2=39.478$; see Appendix~\ref{app:B}), confirming $c_{\mathrm{der}}=4\pi^2$.
...
Because $F_\lambda$ grows essentially linearly in $T\log T\log\log T$,
the estimate is stable: $\widehat{C}_0\approx 9.4\times10^{-3}$ with
$95\%$ CI $[9.1\times10^{-3},\,1.35\times10^{-2}]$.
(The six-point bootstrap CI is necessarily optimistic but is now narrow,
reflecting the monotone growth of~$F_\lambda$.)  The affine residual bound
