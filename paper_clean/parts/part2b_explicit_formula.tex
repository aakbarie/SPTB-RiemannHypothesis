...
Conjecture (Conjecture~\ref{conj:horocycle}).  We stress that this converse is
open \emph{already for the surrogate} $H_\sigma$, not only through the
$G_\sigma$ transfer: the detection theorem reaches only finite off-line
configurations (Proposition~\ref{prop:finite-converse}), leaving the
infinite-family and $\beta-\sigma\to0$ cases as genuine open content.
\end{remark}
