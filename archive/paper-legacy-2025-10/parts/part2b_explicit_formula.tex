...
\end{equation}
where conjugate zeros $\rho,\overline{\rho}$ have been paired so that the
contribution is real: $x^{\rho}/\rho + x^{\overline{\rho}}/\overline{\rho}
= 2|\rho|^{-1}e^{\beta t}\cos(\gamma t+\varphi_\rho)$.
...
of the prime-counting error term \cite{turan-pintz,ingham}. The
