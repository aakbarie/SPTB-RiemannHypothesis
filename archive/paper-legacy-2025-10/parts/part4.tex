...
\begin{remark}[Status]
Sections~\ref{sec:horocycle}–\ref{sec:infogeom} are heuristic.
...
The term \emph{horocycle} is used here as a heuristic label for the critical
level set $u=1$ of the model space $\mathcal{M}$ below; we do not claim a
connection to the horocycle flow on the modular surface or to the
closed-horocycle/Eisenstein-series theory of Sarnak~\cite{sarnak-horocycle}
and Zagier, with which only an analogy is drawn.
\end{remark}
...
% ---------------------------------------------------------
\section{Information-Geometry View}\label{sec:infogeom}
...
\midrule
Connes (spectral)~\cite{connes} & Operator/trace positivity & SPTB: curvature-bounded energy \\
Berry–Keating~\cite{berry-keating} & $H=xp$ semiclassical ansatz & SPTB: geodesic/energy flow \\
Balazs–Vörös~\cite{balazs-voros} & Quantum chaos on the pseudosphere & SPTB: horocycle confinement \\
\bottomrule
\end{tabular}
\end{table}
